...
getLength simply returns the distance between the lower bound and upper bound of a range. Test cases were made for certain scenerios like: validinput, negative ranges, non-negative, etc. 
...
Test case #2: getCumulativePercentagesWithEmptyInput()
Test case #3: getCumulativePercentagesWithSingleElementInput()
Test case #4: getCumulativePercentagesWithValidNegativeInput()
Test case #5: testGetCumulativePercentagesWithMixedValues()
